<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"F:\ZHUANGRILING\phpStudy\WWW\Tp5\public/../application/admin\view\deal\index.html";i:1500002390;s:84:"F:\ZHUANGRILING\phpStudy\WWW\Tp5\public/../application/admin\view\public\header.html";i:1499917624;s:84:"F:\ZHUANGRILING\phpStudy\WWW\Tp5\public/../application/admin\view\public\footer.html";i:1499917560;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td><?php echo $categoryArray[$vo['category_id']]; ?></td>
					<td><?php echo $cityArray[$vo['city_id']]; ?></td>
					<td><?php echo $vo['buy_count']; ?></td>
					<td><?php echo date("y-m-d : h:i", $vo['start_time']); ?>--<?php echo date("y-m-d : h:i", $vo['end_time']); ?></td>
					<td><?php echo $vo['create_time']; ?></td>
					<td><a href="<?php echo url('deal/status',['id'=>$vo['id'], 'status'=>$vo['status']==1?0:1]); ?>" title="点击修改状态"><?php echo status($vo['status']); ?></a></td>
