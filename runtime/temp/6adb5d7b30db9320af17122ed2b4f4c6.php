<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"F:\ZHUANGRILING\phpStudy\WWW\Tp5\public/../application/bis\view\location\index.html";i:1499863158;s:82:"F:\ZHUANGRILING\phpStudy\WWW\Tp5\public/../application/bis\view\public\header.html";i:1499707552;s:82:"F:\ZHUANGRILING\phpStudy\WWW\Tp5\public/../application/bis\view\public\footer.html";i:1499707904;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td><?php echo getLocation($vo['is_main']); ?></td>
					<td class="td-status"><a href="<?php echo url('location/status',['id'=>$vo['id'], 'status'=>$vo['status']==1?0:1]); ?>" title="点击修改状态"><?php echo status($vo['status']); ?></a></td>
