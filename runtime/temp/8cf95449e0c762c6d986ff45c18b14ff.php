<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"F:\ZHUANGRILING\phpStudy\WWW\Tp5\public/../application/index\view\user\register.html";i:1499935151;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="content">
            <form action="<?php echo url('user/register'); ?>" method="post">
                ...
                <p class="pass-form-item">
                    ...
                    <input type="password" name="password_en" class="pass-text-input" placeholder="请设置登录密码">
                </p>
                <p class="pass-form-item">
