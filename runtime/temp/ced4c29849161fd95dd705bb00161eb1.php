<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"F:\ZHUANGRILING\phpStudy\WWW\Tp5\public/../application/index\view\index\index.html";i:1500017651;s:82:"F:\ZHUANGRILING\phpStudy\WWW\Tp5\public/../application/index\view\public\head.html";i:1500087364;s:81:"F:\ZHUANGRILING\phpStudy\WWW\Tp5\public/../application/index\view\public\nav.html";i:1500084775;}*/ ?>
...
<head>
    ...
    <link rel="stylesheet" href="__STATIC__/index/css/common_page.css" />
...
<body>
    <div class="header-bar">
        ...
        <a href="/" ><img src="/static/index/image/logo.png" /></a>
                                ...
                                <div class="section">
                                    <div class="section-item clearfix no-top-border">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="<?php echo url('lists/index',['id'=>$vo['id']]); ?>"><?php echo $vo['name']; ?></a></li>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </ul>
                                    </div>
                    ...
                    <div class="floor-content">
                        <div class="floor-header">
                            ...
                            <ul class="reco-words">
                                ...
                                <li><a href="<?php echo url('detail/index',['id'=>$vo['id']]); ?>" target="_blank"><?php echo $vo['name']; ?></a></li>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                <li><a href="<?php echo url('detail/index',['id'=>1]); ?>" class="no-right-border no-right-padding" target="_blank">全部<span class="all-cate-arrow"></span></a></li>

                            </ul>
                        </div>

                        <ul class="itemlist eight-row-height">
                            <?php if($deal): if(is_array($deal) || $deal instanceof \think\Collection || $deal instanceof \think\Paginator): $i = 0; $__LIST__ = $deal;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <li class="j-card">
                                ...
                                <div class="contentbox">
                                    <a href="<?php echo url('detail/index',['id'=>$vo['id']]); ?>" target="_blank">
                                        <div class="header">
                                            <h4 class="title ">【<?php echo countLocation($vo['location_ids']); ?>家通用】</h4>
                                        </div>
