<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"F:\ZHUANGRILING\phpStudy\WWW\Tp5\public/../application/index\view\detail\index.html";i:1500036011;s:82:"F:\ZHUANGRILING\phpStudy\WWW\Tp5\public/../application/index\view\public\head.html";i:1500024764;s:81:"F:\ZHUANGRILING\phpStudy\WWW\Tp5\public/../application/index\view\public\nav.html";i:1500084775;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="p-bread-crumb">
            <div class="w-bread-crumb">
                <ul class="crumb-list">
                    ...
                    <li class="crumb crumb-last"><a><?php echo $location_name; ?></a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="p-item-info">
            <div class="w-item-info">
                ...
                <div class="item-title">
                    <span class="text-main"><?php echo $deal['notes']; ?></span>
                </div>
                            ...
                            <a class="link jingxuan-box" alt="更多精选品牌特惠">
                                <div class="box">
                                    ...
                                    <div class="jx-update" id="j-jxUpdateTime">
                                        <span>距离开始时间还有</span>
                                        <span class="jx-timerbox"><?php echo $time_dey; ?></span>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <div class="buy-panel">
                                <div class="validdate-buycount-area static-hook-real static-hook-id-11">
                                    ...
                                    <div class="item-buycount-row j-item-buycount-row">
                                        ...
                                        <div class="text-wrap">
                                            <span class="left-budget">优惠价剩余<?php echo $count; ?>份</span>
                                ...
                                <div class="item-buy-area">
                                    <div style="float:left" class="static-hook-real static-hook-id-12">
                                        <?php if($star == 1): ?>
                                        <a href="" class="btn-buy btn-buy-qrnew j-btn-buy btn-hit" style="background:#c0c0c0;border-bottom:#c0c0c0;">立即抢购</a>
                                        <?php else: ?>
                        ...
                        <div class="ia-shop-branch">
                            <div class="w-shop-branch">
                                ...
                                <div class="branch-content">
                                    <div class="shop-map">
                                        <div class="w-map">
                                           <img src="<?php echo url('map/getImage',['data'=>$imgsrc]); ?>">
                                        </div>
                                    </div>
