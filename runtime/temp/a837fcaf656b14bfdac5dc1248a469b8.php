<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"F:\ZHUANGRILING\phpStudy\WWW\Tp5\public/../application/admin\view\featured\index.html";i:1499933047;s:84:"F:\ZHUANGRILING\phpStudy\WWW\Tp5\public/../application/admin\view\public\header.html";i:1499917624;s:84:"F:\ZHUANGRILING\phpStudy\WWW\Tp5\public/../application/admin\view\public\footer.html";i:1499917560;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <table class="table table-border table-bordered table-bg table-hover table-sort">
      ...
      <tbody>
        ...
        <tr class="text-c">
          ...
          <td><a href="" target="_blank"><?php echo $vo['title']; ?></a></td>
          ...
          <td class="td-manage">
            ...
            <a style="text-decoration:none" class="ml-5" onClick="o2o_s_edit('编辑','<?php echo url('featured/edit',['id'=>$vo['id']]); ?>','',300)" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
            <a style="text-decoration:none" class="ml-5" onClick="o2o_del('<?php echo url('featured/status',['id'=>$vo['id'], 'status'=>-1]); ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
          </td>
        </tr>
        <?php endforeach; endif; else: echo "" ;endif; ?>
      </tbody>
